...
# 转换宽表为长表，拆解列名中的结构
long_data <- target_genes[["Helicoverpa_armigera"]] %>%
  pivot_longer(
...
# 自定义顺序（注意：重复项将自动去除）
custom_order <- c(
  "Larva-24_hours","Larva-72_hours","Larva-73_hours","Larva-74_hours","Larva-75_hours","Larva-76_hours","Larva-77_hours","Larva-78_hours","Larva-79_hours","Larva-80_hours","Larva-81_hours","Larva-1_instar", "Larva-2_instar","Larva-3_instar", "Larva-4_instar", "Larva-5_instar","Larva-7_instar","Larva-8_instar","Larva-9_instar",
  "Nymph-2_instar","Nymph-6_instar","Nymph-9_instar","Nymph-25_instar","Nymph-29_instar",
  "Pupa-pre"
)
...
ggsave(
  filename = "Helicoverpa_armigera_Harm004748.pdf",  # 文件路径和名称
